...
grid on
xticks([1 2 3 4 5])
plot(var_y_1, 'DisplayName', 'Potencia de la señal real');
plot(var_y_13_1, 'DisplayName', 'potencia de la señal sintetizada');
...
grid on 
xticks([1 2 3 4 5])
plot(var_y_2, "DisplayName", "Potencia de la señal real", color = 'blue');
plot(var_y_13_2, "DisplayName", "potencia de la señal sintetizada", color = 'red');
xticklabels({'D', 'T', 'A', 'B', 'G'});
legend
